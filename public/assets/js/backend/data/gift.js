define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'data/gift/index',
                    add_url: 'data/gift/add',
                    edit_url: 'data/gift/edit',
                    del_url: 'data/gift/del',
                    multi_url: 'data/gift/multi',
                    table: 'gift',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'maxgift', title: __('Maxgift'), operate:'BETWEEN'},
