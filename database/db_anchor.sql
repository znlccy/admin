...
CREATE TABLE `tb_anchor` (
  ...
  `aid` int(10) unsigned DEFAULT '0' COMMENT '主播名称',
...
insert  into `tb_anchor` values (1,1,1,'','','','','','',45874110,'http://www.baidu.com','normal','signed','weuiruewruiwer23142341','normal',NULL,'');
...
CREATE TABLE `tb_anchor_group` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `name` varchar(50) COLLATE utf8_czech_ci DEFAULT '' COMMENT '组名',
  PRIMARY KEY (`id`)
...
insert  into `tb_gift_config` values (1,'血滴子','/assets/img/wolf.png','0.26','12.87','normal');
