<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:105:"D:\PHP-Environment\Apache2.4.29\htdocs\admin\public/../application/admin\view\company\company\detail.html";i:1524130168;s:87:"D:\PHP-Environment\Apache2.4.29\htdocs\admin\application\admin\view\layout\default.html";i:1523111344;s:84:"D:\PHP-Environment\Apache2.4.29\htdocs\admin\application\admin\view\common\meta.html";i:1523111344;s:86:"D:\PHP-Environment\Apache2.4.29\htdocs\admin\application\admin\view\common\script.html";i:1523111344;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="panel-body">
        <div id="myTabContent" class="tab-content">
                    ...
                    <form id="<?php echo $vo['name']; ?>-form" class="edit-form form-horizontal" role="form" data-toggle="validator" method="POST" action="<?php echo url('general.config/edit'); ?>">
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <th width="70%"><?php echo __('变量值'); ?></th>
            ...
            <div class="tab-pane fade" id="addcfg">
                <form id="add-form" class="form-horizontal" role="form" data-toggle="validator" method="POST" action="<?php echo url('company.company/add'); ?>">
